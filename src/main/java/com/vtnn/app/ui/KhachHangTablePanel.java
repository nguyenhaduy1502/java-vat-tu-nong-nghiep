...
public class KhachHangTablePanel extends JPanel {
    ...
    public KhachHangTablePanel() throws Exception {
        ...
        // Table
        tableModel = new KhachHangTableModel(khachHangDAO.dsKhachHang());
        ...
        addButton.addActionListener(e -> {
            try {
                KhachHangFormDialog dialog = new KhachHangFormDialog(null);
    ...
    private void refreshTable() throws Exception {
        tableModel.setCustomers(khachHangDAO.dsKhachHang());
    }
    ...
    private class ButtonEditor extends DefaultCellEditor {
        ...
        public ButtonEditor(JCheckBox checkBox) {
            ...
            editButton.addActionListener(e -> {
                try {
                    KhachHangFormDialog dialog = new KhachHangFormDialog(customer);
                    dialog.setVisible(true);
                    if (dialog.isSaved()) {
                        refreshTable();
                    }
            ...
            deleteButton.addActionListener(e -> {
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    try {
                        khachHangDAO.xoaKhachHang((int)customer[0]);
                        refreshTable();
                    } catch (Exception ex) {
                        JOptionPane.showMessageDialog(panel,
                            "Lỗi: " + ex.getMessage(),
